...
from accounts.views import edit_profile, register_user, logout_user, login_user, activate, manage_employers, validate, resend_activation, activate_account, validated
...
urlpatterns = [
    ...
    path('edit-profile/candidateInfo', edit_profile),
